<aside class="w-64 bg-[#B0C4DE] shadow-lg flex flex-col px-4 py-6 justify-between min-h-screen">
    <div>
        <div class="flex items-center space-x-3 mb-6 px-2">
            <img src="{{ asset('images/logo.png') }}" alt="Logo" class="w-12 h-12 rounded-full border">
            <div>
                <p class="font-bold text-lg text-[#293462]">JePhone</p>
        ...
        <nav class="flex flex-col text-sm space-y-1 text-black font-semibold">
            ...
            <a href="{{ route('pembelian.create') }}" class="flex items-center py-2 px-3 rounded hover:bg-[#293462] hover:text-white transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="currentColor" viewBox="0 0 24 24" stroke="none">
                    <path d="M2.25 2.25a.75.75 0 0 0 0 1.5h1.386c.17 0 .318.114.362.278l2.558 9.592a3.752 3.752 0 0 0-2.806 3.63c0 .414.336.75.75.75h15.75a.75.75 0 0 0 0-1.5H5.378A2.25 2.25 0 0 1 7.5 15h11.218a.75.75 0 0 0 .674-.421 60.358 60.358 0 0 0 2.96-7.228.75.75 0 0 0-.525-.965A60.864 60.864 0 0 0 5.68 4.509l-.232-.867A1.875 1.875 0 0 0 3.636 2.25H2.25ZM3.75 20.25a1.5 1.5 0 1 1 3 0 1.5 1.5 0 0 1-3 0ZM16.5 20.25a1.5 1.5 0 1 1 3 0 1.5 1.5 0 0 1-3 0Z" />
                </svg>
                Pembelian
            </a>
            <a href="{{ route('piutang.daftar') }}" class="flex items-center py-2 px-3 rounded hover:bg-[#293462] hover:text-white transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="currentColor" viewBox="0 0 24 24" stroke="none">
            ...
            <a href="{{ route('histori.pembelian') }}" class="flex items-center py-2 px-3 rounded hover:bg-[#293462] hover:text-white transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="currentColor" viewBox="0 0 24 24" stroke="none">
            ...
            <a href="{{ route('user.index') }}" class="flex items-center py-2 px-3 rounded hover:bg-[#293462] hover:text-white transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="currentColor" viewBox="0 0 24 24" stroke="none">
    ...
    <!-- Logout -->
    <div class="mt-auto">
        <a href="{{ route('logout') }}" class="group flex items-center py-2 px-3 rounded hover:bg-[#293462] hover:text-white transition-colors text-red-600 font-semibold">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-red-600 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24" stroke="currentColor">
