    ...
    <div>
        ...
        <nav class="flex flex-col text-sm space-y-1 text-black font-semibold">
            <a href="{{ route('dashboard') }}" 
               class="flex items-center py-2 px-3 rounded transition-colors
                      {{ request()->routeIs('dashboard') 
                         ? 'bg-[#293462] text-white' 
                         : 'hover:bg-[#293462] hover:text-white' }}">
            ...
            <a href="{{ route('piutang.daftar') }}" 
               class="flex items-center py-2 px-3 rounded transition-colors
                      {{ request()->routeIs('piutang.*') 
                         ? 'bg-[#293462] text-white' 
                         : 'hover:bg-[#293462] hover:text-white' }}">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="currentColor" viewBox="0 0 24 24" stroke="none">
            ...
            <a href="{{ route('histori.pembelian') }}" 
               class="flex items-center py-2 px-3 rounded transition-colors
                      {{ request()->routeIs('histori.pembelian') 
                         ? 'bg-[#293462] text-white' 
                         : 'hover:bg-[#293462] hover:text-white' }}">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="currentColor" viewBox="0 0 24 24" stroke="none">
            ...
            <a href="{{ route('laporan.aruskas') }}" 
                class="flex items-center py-2 px-3 rounded transition-colors
                      {{ request()->routeIs('laporan.aruskas') 
                         ? 'bg-[#293462] text-white' 
                         : 'hover:bg-[#293462] hover:text-white' }}">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="currentColor" viewBox="0 0 24 24" stroke="none">
